                    ...
                    <div class="form-body" >
                       <!-- JAVASCRIPT ADD ITEM TO ORDER CONTENT WILL BE HERE -->
                        ...
                        <div class="col-lg-5" style="color: white">
                            <form method="post" action="create_orderT">
                        ...
                        <div class="col-lg-6">
                                <div>
                                    <h4 style="color:white;"><?php $oid=$_SESSION['order_id']; echo "Order No.:".$oid;?></h4>
                                    ...
                                    <div class="panel-body">
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                ?>
                                                <tr>
                                                <form action="addfakeT" method="post">
                            ...
                            <div class="col-md-6">
                                <div align="center">
                                    <div class="panel panel-info" style="color:black;">
                                        ...
                                        <div class="panel-body">
                                            <div class="table-responsive">
                                            <form action="complete_orderT" method="post">
                                                <table class="table table-bordered">
                                                <tr>
                                                    <th>Item ID</th>
                                                    <th>Item Name</th>
